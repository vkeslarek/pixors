...
use crate::convert::{ColorConversion, Matrix3x3};
...
impl ColorSpace {
    ...
    pub const fn as_linear(self) -> Self { Self::new(self.primaries, self.white_point, TransferFn::Linear) }
    ...
    pub fn matrix_to(self, dst: ColorSpace) -> Result<Matrix3x3, Error> {
        ...
        crate::convert::rgb_to_rgb_transform(self.primaries, self.white_point, dst.primaries, dst.white_point)
    }
