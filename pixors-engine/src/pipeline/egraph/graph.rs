...
use crate::pipeline::egraph::stage::{ExecStage, Stage};
...
/// Compiled, ready-to-run pipeline produced by `sgraph::compile`.
///
...
pub struct ExecGraph {
    pub graph: StableDiGraph<ExecStage, ExecEdgePorts>,
...
impl ExecGraph {
    ...
    pub fn add_stage(&mut self, stage: ExecStage) -> StageId {
