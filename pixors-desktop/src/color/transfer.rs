...
mod tests {
    ...
    #[test] fn linear_inverse()   { assert_inverse(TransferFn::Linear); }
    #[test] fn srgb_inverse()     { assert_inverse(TransferFn::SrgbGamma); }
    #[test] fn rec709_inverse()   { assert_inverse(TransferFn::Rec709Gamma); }
    #[test] fn gamma22_inverse()  { assert_inverse(TransferFn::Gamma22); }
    #[test] fn gamma24_inverse()  { assert_inverse(TransferFn::Gamma24); }
    #[test] fn gamma26_inverse()  { assert_inverse(TransferFn::Gamma26); }
    #[test] fn prophoto_inverse() { assert_inverse(TransferFn::ProPhotoGamma); }
    #[test] fn pq_inverse()       { assert_inverse(TransferFn::Pq); }
    #[test] fn hlg_inverse()      { assert_inverse(TransferFn::Hlg); }
}
