...
use crate::ui::theme::{
    ACCENT, ACCENT_GLOW, ACCENT_DIM, BG_HOVER, BG_SURFACE, BORDER_SUBTLE,
    TEXT_MUTED, TEXT_SECONDARY, TOOLBAR_W,
};
...
fn tool_btn(t: Tool, active: bool) -> Element<'static, Msg> {
    ...
    button(inner)
        ...
        .style(move |_, status| {
            ...
            let border_color = if active { ACCENT_GLOW } else { Color::TRANSPARENT };
            button::Style {
